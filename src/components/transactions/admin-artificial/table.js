                                                        ...
                                                        <tr>
                                                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-button">
                                                                <div className="flex items-center">
                                                                    <div>
                                                                        <div className="text-sm leading-5 text-white-primary font-semibold">{item.id.substring(0, 8)}</div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            {
                                        ...
                                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                                ...
                                                <div>
                                                    ...
                                                    <button
                                                        type="button"
                                                        className={`bg-blue-primary border border-gray-300 text-white-normal font-bold text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${isInvalid ? 'cursor-not-allowed hover:bg-red-warning' : 'cursor-pointer hover:bg-green-button'}`}
