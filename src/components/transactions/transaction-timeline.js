...
import ArtificialTransactionsWithdrawal from './artificial'
...
const TransactionTimeline = () => {
  ...
  const { user, user: { userId, username, rol } } = useUser()
        ...
        <section className={`${styles.section} container`}  >
          {
            ...
            user?.rol === 'admin' && user?.rol !== 'investor' && user?.rol !== '' && user?.rol !== 'sponsored' || user?.rol === 'owner' ?
              (
                <TransactionsAdmin
                  rol={rol}
              ...
              : user?.rol !== 'admin' && user?.rol === 'investor' || user?.rol !== 'admin' && user?.rol === 'sponsored' ?
                (
                  <Error>
                    <ArtificialTransactionsWithdrawal />
                  </Error>
