                ...
                <div className="w-40 mt-2 bg-white  rounded">
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-gree-700 font-bold">
                                {parseFloat(user?.WithdrawalMexican).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-indigo-700 font-bold">
                                {parseFloat(user?.WithdrawalColombian).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-indigo-700 font-bold">
                                {parseFloat(user?.WithdrawalTether).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-indigo-700 font-bold">
                                {parseFloat(user?.WithdrawalBrasil).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
