                ...
                <div className="w-40 mt-2 bg-white  rounded">
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-gree-700 font-bold">
                                {parseFloat(user?.ProfitMexican).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-indigo-700 font-bold">
                                {parseFloat(user?.ProfitColombian).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-indigo-700 font-bold">
                                {parseFloat(user?.ProfitTether).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <p className="w-8 text-md leading-3 text-right text-indigo-700 font-bold">
                                {parseFloat(user?.ProfitBrasil).toLocaleString('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                })}
                            </p>
