...
const StakingSimulatorTron = (props) => {
            ...
            <div className={`${styles.StakingFormWrapper}`}>
                ...
                <div className={`${styles.StakingCryptoCards}`}>
                    <span className='flex flex-row justify-start items-center gap-4 rounded-lg w-full'>
                        ...
                        <p className='text-white-normal font-medium capitalize'>Polkadot</p>
                    </span>
...
export default StakingSimulatorTron

StakingSimulatorTron.propTypes = {
