                    ...
                    <div className='bg-black-normal mx-auto w-full h-full overflow-scroll'>
                        <div className='flex flex-col justify-between items-center gap-20'>
                            ...
                            <span className='flex items-center gap-5 justify-center flex-col'>
                                <h1 className='text-3xl font-bold text-white-primary uppercase mt-10'>{t('platform Users List')}</h1>
                                <p className='text-red-logo text-base'>{t('Sponsored accounts will be displayed in Red')}</p>
                            ...
                            <div className="relative text-gray-600 flex justify-center items-center w-full">
                                <input type="search" name="serch" placeholder="Search User" className="bg-black-background text-center text-white-normal h-10 px-5 pr-10 rounded-full text-sm focus:outline-none w-1/2 xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-11/12 "
                                    onChange={e => {
                                ...
                                {filteredTransactions.map((user, k) => (
                                    <tbody key={k} className='w-full text-center overflow-scroll'>
                                        <tr className='text-gray-700'>
                                            ...
                                            <td
                                                className='border p-4 dark:border-gray-info capitalize text-red-warning cursor-pointer'
                                                onClick={() => {
                                                    toggleModalReferral(user)
                                                    setDocId(user.id)
                                                    setReferrers(user)
                                                }}
                                            >
